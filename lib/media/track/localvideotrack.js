...
class LocalVideoTrack extends LocalMediaVideoTrack {
   ...
   * @private
   */
  _updateSenderMediaStreamTrack(mediaStreamTrack) {
  ...
  addProcessor() {
    ...
    this._updateSenderMediaStreamTrack(this.processedTrack);
  ...
  removeProcessor() {
    ...
    this._updateSenderMediaStreamTrack(this._unprocessedTrack)
